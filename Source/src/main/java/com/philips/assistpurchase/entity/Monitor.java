package com.philips.assistpurchase.entity;
...
public class Monitor {
	...
	public Monitor(int id,String name, double price,boolean is_Wireless,boolean is_Touchscreen,boolean is_Interoperable,boolean connectivitywith_EMR, String image, String description ) {
	    super();
	    this.id=id;
	    this.name = name;
	    this.price = price;
